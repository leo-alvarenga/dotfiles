...
theme.bg_focus      = colors.comment
theme.bg_urgent     = colors.red
theme.bg_minimize   = colors.comment
theme.bg_systray    = theme.bg_normal
theme.wibar_bg      = colors.selection .. '30'
...
theme.border_focus  = colors.comment
theme.border_marked = colors.pink

theme.taglist_shape_border_color = colors.pink
theme.border_shadow_color = colors.selection .. '20'
